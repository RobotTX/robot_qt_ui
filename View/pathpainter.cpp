...
PathPainter::PathPainter(MapView * const &mapPixmapItem, const std::shared_ptr<Points> &_pointViews) : QGraphicsPathItem(mapPixmapItem), pointViews(_pointViews), mapItem(mapPixmapItem)
{
    setPen(QPen(Qt::red));
}
