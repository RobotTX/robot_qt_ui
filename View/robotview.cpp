...
RobotView::RobotView (QSharedPointer<Robot> const &_robot, QGraphicsItem* parent): robot(_robot), selected(false), state(GraphicItemState::NO_STATE), shown(true), QGraphicsPolygonItem(parent)
{
