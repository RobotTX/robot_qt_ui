...
#include <QThread>
#include "Controller/Robots/cmdrobotworker.h"
#include "Controller/Robots/robotpositionworker.h"
...
public:
    ...
    bool isRecovering(void) const { return recovering; }
    ...
    void setRecovering(const bool _recovering) { recovering = _recovering; }
