            ...
            if(selectedRobot->getRobot()->sendCommand("f")){
                ...
                if(answerList.size() > 1){
                    ...
                    if(cmd.compare("f") == 0 && success){
                        ...
                        enableMenu();
                        topLayout->setLabel(TEXT_COLOR_SUCCESS, "Map finished");
                    } else {
