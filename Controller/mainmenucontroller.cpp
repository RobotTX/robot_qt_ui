...
MainMenuController::MainMenuController(QQmlApplicationEngine *engine, QObject *parent) : QObject(parent){
    ...
    if(qmlList.size() == 1){
        ...
        QObject *robotMenuHeader = qmlList.at(0)->findChild<QObject*>("robotMenuHeader");
        if (robotMenuHeader){
        ...
        QObject *pathMenuHeader = qmlList.at(0)->findChild<QObject*>("pathMenuHeader");
        if (pathMenuHeader){
        ...
        QObject *pointMenuHeader = qmlList.at(0)->findChild<QObject*>("pointMenuHeader");
        if (pointMenuHeader){
        ...
        QObject *mapMenuHeader = qmlList.at(0)->findChild<QObject*>("mapMenuHeader");
        if (mapMenuHeader){
        ...
        QObject *settingsMenuHeader = qmlList.at(0)->findChild<QObject*>("settingsMenuHeader");
