...
QT_MOC_LITERAL(1, 6, 10), // "pingSignal"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 17), // "sendCommandSignal"
QT_MOC_LITERAL(4, 36, 3), // "cmd"
QT_MOC_LITERAL(5, 40, 16), // "sendNewMapSignal"
QT_MOC_LITERAL(6, 57, 21) // "doneSendingNewMapSlot"

    },
    "Robot\0pingSignal\0\0sendCommandSignal\0"
    "cmd\0sendNewMapSignal\0doneSendingNewMapSlot"
};
...
void Robot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pingSignal(); break;
        case 1: _t->sendCommandSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->sendNewMapSignal((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 3: _t->doneSendingNewMapSlot(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Robot::pingSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Robot::sendCommandSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Robot::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Robot::sendNewMapSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Robot::pingSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Robot::sendCommandSignal(QString _t1)
{
...
// SIGNAL 2
void Robot::sendNewMapSignal(QByteArray _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
