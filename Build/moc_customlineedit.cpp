...
QT_MOC_LITERAL(1, 15, 14), // "clickSomewhere"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 4), // "name"
QT_MOC_LITERAL(4, 36, 15) // "enableGroupEdit"

    },
    "CustomLineEdit\0clickSomewhere\0\0name\0"
    "enableGroupEdit"
};
...
void CustomLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickSomewhere((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->enableGroupEdit((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CustomLineEdit::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomLineEdit::clickSomewhere)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CustomLineEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomLineEdit::enableGroupEdit)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CustomLineEdit::clickSomewhere(QString _t1)
{
...
// SIGNAL 1
void CustomLineEdit::enableGroupEdit(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
